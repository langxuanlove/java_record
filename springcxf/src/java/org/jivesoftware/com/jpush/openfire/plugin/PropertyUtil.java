...
public class PropertyUtil{
	...
	public static String getProperty(String key) {  
		System.out.println("get操作 jpush.properties文件路径是："+f);
        String value = "";  
        // 第一步是取得一个Properties对象  
        Properties props = new PropertiesImpl();  
        // 第二步是取得配置文件的输入流  
        try {  
        	InputStream is =  new FileInputStream(f);//在非WEB环境下用这种方式比较方便  
	...
	public static void setProperty(String key,String value) {  
		System.out.println("set操作 jpush.properties文件路径是："+f);
